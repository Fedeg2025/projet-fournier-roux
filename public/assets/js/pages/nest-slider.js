...
const nidSlider = document.querySelector(".curseur-nid");

if (nidSlider) {
  const track = nidSlider.querySelector(".curseur-nid__piste");
  const slides = nidSlider.querySelectorAll(".curseur-nid__diapositive");
