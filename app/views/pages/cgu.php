...
<main>
    ...
    <!-- =========================
         ...
         ========================= -->
    <section>
        <h3>3. Fonctionnement du site</h3>
        <p>
    ...
    <!-- =========================
         ...
         ========================= -->
    <section>
        <h3>5. Gestion du compte utilisateur</h3>
        <p>
    ...
    <!-- =========================
         ...
         ========================= -->
    <section>
        <h3>6. Engagements de l’utilisateur</h3>
        <p>
        ...
        <ul>
            ...
            <li>ne pas tenter d’accéder de manière frauduleuse aux systèmes ou aux données ;</li>
            <li>ne pas utiliser le site à des fins illicites ou abusives ;</li>
            <li>ne pas diffuser de contenus inappropriés via les formulaires du site.</li>
        </ul>
    </section>
